                                                    ...
                                                    <div class="col-lg-6">
                                                        <form role="form" action="index.php" method="post">
                                                            <?php 
                                                                ...
                                                                $organ_no = $_POST["organ_no"];
                                                                $date_collected = $_POST["date_collected"];

                                                                include 'dbconn.php';
                                                                //code after connection is successfull
                                                                $qry = "insert into organ(organ_name,organ_no,date_collected) values ('$organ_name','$organ_no','$date_collected')";
                                                                ...
                                                                if(!$result){
                                                                    ...
                                                                    echo" <a href='organ.php' div style='text-align: left'><h3>Go Back</h3>";
