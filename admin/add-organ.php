        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>    
                    ...
                    <p style="font-size: 23px;padding-left:12px;font-weight: 600;margin-left:20px;">Add Organ Detals </p>
                                ...
                                <td width="50%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td style="width: 25%;">
                                                        <form role="form" action="addedorgan.php" method="post">
                                                            <div class="form-group">
                                                                <label>Enter Organ Name</label>
                                                                <input class="form-control" type="text" name="organ_name" required>
                                                            </div>
                                                            
                                                            <div class="form-group">
                                                                <label>Enter organ quantity</label>
                                                                <input class="form-control" type="number" name="organ_no" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Collection Date</label>
                                                                <input class="form-control" type="date" name="date_collected" required>
                                                            </div>
