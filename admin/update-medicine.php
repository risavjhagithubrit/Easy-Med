            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                <tr>
                    <td colspan="2" class="nav-bar" >
                        <div class="col-lg-12">
                            <h1 class="page-header" style="margin-left:40px;">Edit Medicine Detail</h1>
                        </div>   
                    </td>
                    <td width="15%">
...
include 'db.php';
$id=$_GET['id'];
$qry= "select * from medicine where id='$id'";
$result=mysqli_query($co,$qry);
while($row=mysqli_fetch_array($result)){
    
?>                                    
                                    <form role="form" action="edit3.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="qty" value='<?php echo $row['qty']; ?>'>
                                        </div>
