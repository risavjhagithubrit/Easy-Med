...
include 'dbconn.php';
$id=$_GET['id'];
$qry= "select * from organ where id='$id'";
$result=mysqli_query($conn,$qry);
while($row=mysqli_fetch_array($result)){
    
?>                                    
                                    <form role="form" action="edit2.php" method="post">
                                     
                                        <div class="form-group">
                                            <label>Enter Organ Name</label>
                                            <input class="form-control" name="organ_name" type="text" value='<?php echo $row['organ_name']; ?>' required>
                                        </div>

                                        <div class="form-group">
                                            <label>Available</label>
                                            <input class="form-control" type="number" name="organ_no" value='<?php echo $row['organ_no']; ?>' required>
                                        </div>
