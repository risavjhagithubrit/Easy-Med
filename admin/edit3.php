...
<?php
                ...
                $id=$_POST['id'];
                //update query
                $qry = "update medicine set name='$name',price='$price',qty='$qty' where id='$id'";
                $result = mysqli_query($co,$qry); //query executes

                if(!$result){
                    echo"ERROR". mysqli_error();
                }else {
                    echo" <div style='text-align: left'><h1>SUCCESSFULLY UPDATED</h1>";
                    echo" <a href='pharmacy.php' div style='text-align: left'><h3>Go Back</h3>";
