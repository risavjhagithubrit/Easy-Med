        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>    
                    ...
                    <div class="col-lg-12">
                    <h1 class="page-header" style="margin-left:20px">Make a request</h1>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="added1.php" method="post"style="margin:40px">
                                        ...
                                        <div class="form-group">
                                            <label>Comment</label>
                                            <input class="form-control" type="text" placeholder="Enter Comment Here" name="comment" required >
                                        </div>
